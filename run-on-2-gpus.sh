...
CUDA_VISIBLE_DEVICES=4,5 torchrun --standalone --nproc_per_node=2 train_gpt2.py \
...
# after run above command, 3 linux processes will be launched, they are :

# /home/zhangfaen/miniconda3/envs/modded-nanogpt/bin/python /home/zhangfaen/miniconda3/envs/modded-nanogpt/bin/torchrun --standalone --nproc_per_node=2 train_gpt2.py --input_bin data/fineweb10B/fineweb_train_*.bin --input_val_bin data/fineweb10B/fineweb_val_*.bin --output_dir pylog124M --model d12 --batch_size 64 --sequence_length 1024 --total_batch_size 131072 --val_loss_every 128 --num_iterations 9536 --weight_decay 0.1 --learning_rate 0.0018 --warmup_iters 256 --warmdown_iters 2048
# (pid: 645316) /home/zhangfaen/miniconda3/envs/modded-nanogpt/bin/python -u train_gpt2.py --input_bin data/fineweb10B/fineweb_train_*.bin --input_val_bin data/fineweb10B/fineweb_val_*.bin --output_dir pylog124M --model d12 --batch_size 64 --sequence_length 1024 --total_batch_size 131072 --val_loss_every 128 --num_iterations 9536 --weight_decay 0.1 --learning_rate 0.0018 --warmup_iters 256 --warmdown_iters 2048
# (pid: 645317) /home/zhangfaen/miniconda3/envs/modded-nanogpt/bin/python -u train_gpt2.py --input_bin data/fineweb10B/fineweb_train_*.bin --input_val_bin data/fineweb10B/fineweb_val_*.bin --output_dir pylog124M --model d12 --batch_size 64 --sequence_length 1024 --total_batch_size 131072 --val_loss_every 128 --num_iterations 9536 --weight_decay 0.1 --learning_rate 0.0018 --warmup_iters 256 --warmdown_iters 2048

# they are 3 different linux processed. I think the 1st is the master process and the 2rd and the 3rd are slave processed.
# run $ ps cat /proc/645316/environ | tr '\0' '\n', get below:
...
# _=/home/zhangfaen/dev/modded-nanogpt/./run.sh
...
# TORCHELASTIC_RUN_ID=73ea9905-b8df-4807-a792-196216517e58
# TORCHELASTIC_USE_AGENT_STORE=False
# TORCH_NCCL_ASYNC_ERROR_HANDLING=1
# TORCHELASTIC_ERROR_FILE=/tmp/torchelastic_ubr6iqfh/73ea9905-b8df-4807-a792-196216517e58_7prnfs80/attempt_0/0/error.json

# run $ ps cat /proc/645317/environ | tr '\0' '\n', get below:
# LESSOPEN=| /usr/bin/lesspipe %s
# CONDA_PROMPT_MODIFIER=(modded-nanogpt) 
# USER=zhangfaen
# SSH_CLIENT=121.69.59.14 56664 58320
...
# TORCHELASTIC_USE_AGENT_STORE=False
# TORCH_NCCL_ASYNC_ERROR_HANDLING=1
# TORCHELASTIC_ERROR_FILE=/tmp/torchelastic_ubr6iqfh/73ea9905-b8df-4807-a792-196216517e58_7prnfs80/attempt_0/1/error.json

# the 2 slave processes env values only different at LOCAL_RANK, RANK and ROLE_RANK. 